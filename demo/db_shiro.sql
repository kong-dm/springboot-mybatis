...
CREATE TABLE `tb_resource` (
  `res_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
CREATE TABLE `tb_role` (
  ...
  `role_desc` varchar(255) DEFAULT NULL COMMENT '角色资源信息',
  PRIMARY KEY (`role_id`)
...
CREATE TABLE `tb_role_resource` (
  ...
  PRIMARY KEY (`rr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='角色资源表';
